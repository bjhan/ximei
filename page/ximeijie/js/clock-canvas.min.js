!(function ($, window, document, undefined) {
    ...
    Clock.prototype = {
        drawBackground: function (_ctx, r, rem, isNumCol, noNumCol) {
            ...
            var width = this.$element.width(), height = this.$element.height(), _ctx = this.context, r = width / 2,
                rem = width / 200, isNumCol = this.options.isNumCol, noNumCol = this.options.noNumCol,
                hCol = this.options.hCol, mCol = this.options.mCol, sCol = this.options.sCol, dCol = this.options.mCol;
            var date = new Date(), hour = date.getHours()+this.options.shijiancha, minute = date.getMinutes(), second = date.getSeconds();
