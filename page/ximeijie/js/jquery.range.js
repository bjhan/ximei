;(function ($, window, document, undefined) {
    ...
    jRange.prototype = {
        defaults: {
			...
			<div class="back-bar">\
                ...
                <div class="pointer low"></div><div class="pointleft pointer-label">123456</div>\
                <div class="pointer high"></div><div class="pointright pointer-label">456789</div>\
                <div class="clickable-dummy"></div>\
            </div>\
            <div class="scale"></div>\
		</div>', init: function (node, options) {
            ...
            if (this.isSingle())
                this.setPosition(this.pointers.last(), x, true, true); else {
            ...
            var leftPos, lowPos = this.lowPointer.position().left, highPos = this.highPointer.position().left,
            ...
            ///////////////////////////////////////////////////
            var width = label.html(text).width(), left = position - width / 2;
            left = Math.min(Math.max(left, 0), this.options.width - width);
            label[animate ? 'animate' : 'css']({left: 0});
    ...
    $.fn[pluginName] = function (option) {
        ...
        this.each(function () {
            var $this = $(this), data = $.data(this, 'plugin_' + pluginName),
